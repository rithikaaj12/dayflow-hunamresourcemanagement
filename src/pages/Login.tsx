...
export const Login: React.FC = () => {
  const [email, setEmail] = useState('employee@dayflow.io');
  ...
  const handleSelectDemo = (role: UserRole, demoEmail: string) => {
    ...
    setEmail(demoEmail);
    setPassword(role === 'admin' ? 'Demo@123' : 'Demo@123');
  };
          ...
          <div>
            ...
            <div className="mt-6 p-3.5 bg-slate-50 rounded-2xl border border-slate-200">
              ...
              <div className="grid grid-cols-3 gap-2">
                <button
                  type="button"
                  onClick={() => handleSelectDemo('employee', 'employee@dayflow.io')}
                ...
                <button
                  type="button"
                  onClick={() => handleSelectDemo('admin', 'admin@dayflow.io')}
                  className={`p-2 rounded-xl text-left border transition-all ${
                    selectedRole === 'admin'
                      ? 'bg-emerald-600 text-white border-emerald-600 shadow-xs'
                      : 'bg-white text-slate-700 border-slate-200 hover:border-slate-300'
